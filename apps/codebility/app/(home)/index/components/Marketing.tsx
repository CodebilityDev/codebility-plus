...
import GridBg from "@/app/(home)/index/components/GridBg"
import PurpleBg from "@/app/(home)/index/components/PurpleBg"
import { MarketingCardData } from "@/app/(home)/index/components/data"
import MarketingCard from "@/app/(home)/index/components/MarketingCard"
...
const Marketing = () => {
  return (
    <div className="w-full">
      ...
      <GridBg />
      <section id="1" className="relative flex min-h-screen w-full text-light-900 md:flex-row  md:justify-between ">
        ...
        <div className="z-[9999] flex flex-col items-center justify-center">
          <div className="max-w-[704px] px-4">
            <h1 className="pt-20 text-center text-2xl font-bold uppercase md:pt-32 md:text-2xl">Codebility</h1>
            <h2 className="pt-2 text-center text-3xl font-bold md:text-5xl">
              We lead in digital <br /> innovation & design
            </h2>
            <h3 className="py-4 text-center text-lg">Helping you achieve impact results</h3>
            <div className="flex flex-col items-center justify-center gap-4 md:flex-row ">
              <Button variant="purple" rounded="full">
                Start your custom solution
              </Button>
              <Button variant="outlined" className="hover:opacity-15" rounded="full">
                Learn more.
              </Button>
            </div>
