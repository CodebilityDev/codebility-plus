...
import { ServicesCardData } from "@/app/(home)/index/components/data"
import ServicesCard from "@/app/(home)/index/components/ServicesCard"
import { Button } from "@/Components/ui/button"

const Services = () => {
  return (
    <div id="2" className="relative min-h-screen w-full  pt-20 text-light-900">
      <div className="flex flex-col items-center justify-center">
        <div className="max-w-[1000px] px-4">
          <h1 className="text-left text-lg text-[#9747FF]">In the tech industry</h1>
          ...
          <p>
            Our programs go beyond skill acquisition, because acquisition, because we believe in the <br />{" "}
            trans-formative power of coding
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-6 md:pt-20">
            <Button variant="outlined" className="hover:opacity-70" rounded="full">
              Hire Codebility
            </Button>
