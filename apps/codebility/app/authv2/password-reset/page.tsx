...
const PasswordReset = () => {
  return (
    <div className="bg-dark-300 flex min-h-screen flex-col items-center justify-center text-white lg:flex-row">
      <div className="bg-dark-100 flex h-full w-full flex-col justify-between gap-2 rounded-sm px-4 py-10 md:p-10 md:h-[475px] md:w-[497px]">
        ...
        <p className="mx-auto text-sm text-white">
          Have an account?{" "}
          <Link href="/authv2/sign-in" className="text-blue-100 hover:underline">
            Login
          </Link>
        </p>
      </div>
