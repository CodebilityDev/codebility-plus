...
const Roadmap = () => {
  return (
    <SectionWrapper id="roadmap" className="w-full xl:py-0">
      ...
      <div className="bg-roadmap mx-auto hidden max-w-screen-xl bg-contain bg-center bg-no-repeat lg:relative lg:flex lg:h-[800px]">
        <div className="absolute left-0 top-1/2 h-1/2 w-1/2 -translate-y-1/2 transform">
          ...
          <div className="relative h-full w-full">
            ...
            {/* Second Roadmap Section - Codev */}
            <div className="absolute -bottom-0 -right-56 flex w-max flex-col gap-3 text-white md:mx-auto xl:-bottom-16">
              <h3 className="text-customTeal text-lg font-medium xl:text-2xl">
                {roadmapData[1]?.phase}
              </h3>
              <h2 className="text-customTeal text-xl font-semibold xl:text-3xl">
        ...
        <span className="absolute bottom-[300px] right-[100px] h-6 w-6 animate-ping rounded-full bg-purple-600 opacity-75 xl:bottom-[250px] xl:right-[167px]"></span>

        <div className="absolute right-0 top-0 h-1/2 w-1/2">
          <div className="relative h-full w-full">
            {/* Third Roadmap Section - Mentor */}
            <div className="absolute -left-10 top-40 flex w-max flex-col gap-3 text-white md:mx-auto xl:-left-10 xl:top-24">
              <h3 className="text-customTeal text-lg font-medium xl:text-2xl">
                {roadmapData[2]?.phase}
              </h3>
              <h2 className="text-customTeal text-xl font-semibold xl:text-3xl">
