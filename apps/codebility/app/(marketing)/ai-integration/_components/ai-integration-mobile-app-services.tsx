...
import { mobileAppServicesData } from "@/app/(marketing)/ai-integration/_components/data"

const MobileAppServices = () => {
  return (
    <div className="max-w-screen-2xl mx-auto mt-16 flex flex-col gap-5 md:mt-20 md:gap-7 xl:mt-32">
      ...
      <p className="text-lg md:mx-auto md:w-3/4 md:text-center lg:w-full lg:text-xl">
        Dynamic Mobile App Development Solutions: Elevate Your Business, Captivate Your Audience
      </p>
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row">
        {mobileAppServicesData.map((service) => (
          <div key={service.id} className="relative">
            <Image
              src={service.image || "https://codebility-cdn.pages.dev/assets/images/dafault-avatar-1248x845.jpg"}
              width={0}
              height={0}
              alt={service.title}
