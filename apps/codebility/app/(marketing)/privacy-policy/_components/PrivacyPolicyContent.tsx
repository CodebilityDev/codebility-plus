...
export default function PrivacyPolicyContent() {
  const skeleton = (
    <div className="flex flex-col gap-8 py-10">
      ...
      <p>
        Thank you for choosing to be part of our community at Codebility. We are
      ...
      <div className="mx-auto px-8 py-8 sm:px-[95px] sm:pt-[61px] lg:max-w-screen-xl">
        <MarketingProgressiveSection skeleton={skeleton}>
          ...
          >
            ...
            <ol
              data-progressive-child
              className="flex list-decimal flex-col gap-5"
            >
              <li>
                ...
                <p>
                  ...
                  include the following:- Personal Information Provided by You.
              ...
              <li>
                ...
                <p>
                  ...
                  listed below. We use the information we collect or receive: -
              ...
              <li>
                ...
                <p>
                  ...
                  rights, or to fulfill business obligations. We may process or
                  share your data that we hold based on the following legal
                  basis: - Consent: We may process your data if you have given
                  us specific consent to use your personal information in a
                  specific purpose.
                </p>
              </li>
              <li>
            ...
            <p data-progressive-child>Last Updated: March 2024</p>
          </ProgressiveMotion>
