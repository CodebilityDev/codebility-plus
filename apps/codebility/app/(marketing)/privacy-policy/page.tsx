...
const PrivacyPolicy = () => {
    return (
        <>
            <div className="bg-backgroundColor text-primaryColor relative flex w-full flex-col overflow-x-hidden overflow-y-hidden">
                <div className="mx-auto px-8 py-8 sm:px-[95px] sm:pt-[61px] lg:max-w-screen-xl">
                    <div className="flex flex-col gap-8 py-10">
                        ...
                        <p>
                            ...
                            or concerns about our policy or our practices with regard to your
                        ...
                        <p>
                            ...
                            our website (<Link href="/">https://www.codebility.tech/</Link>),
                        ...
                        <ol className="flex list-decimal flex-col gap-5">
                            <li>
                                ...
                                <p>
                                    ...
                                    us. We collect personal information that you voluntarily
                                    ...
                                    or otherwise when you contact us. The personal information
                                    ...
                                    collect may include the following:- Personal Information
                                    Provided by You. We collect names; phone numbers; email
                                    addresses; usernames; passwords; contact preferences; contact
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    Services for a variety of business purposes described below.
                                    ...
                                    purpose listed below. We use the information we collect or
                                    receive: - To facilitate account creation and logon process.
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    process or share your data that we hold based on the following
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    <span className="font-bold">
                                        ...
                                        Communicate and Chat with Users - Content Optimization -
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    set out in this privacy policy, unless a longer retention
...
<p className="mb-3 font-bold">How do we keep your information safe?</p>
                                <p>
                                    ...
                                    a system of organizational and technical security measures. We
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    consent to such minor dependent&apos;s use of the Services. If
                                    we learn that personal information from users less than 18
