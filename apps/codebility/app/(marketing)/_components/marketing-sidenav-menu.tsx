      ...
      {links.map((link, index) => (
        ...
        >
          ...
          <div
            ...
            } border-light-900/5 bg-light-700/10 group items-center gap-2 rounded-md border-2 ps-4 text-white backdrop-blur-lg duration-300 hover:ml-4 hover:w-36  hover:bg-[#9747FF] hover:text-base hover:text-opacity-100 hover:opacity-100 xl:h-10`}
          >
            <p
