      ...
      >
        <div className="flex max-h-[500px] flex-col gap-2 overflow-hidden overflow-y-scroll p-20 ">
          ...
          <Accordion title="Q1 What makes Codebility different from other development companies?">
            Lorem ipsum dolor sit amet consectetur adipiscing elit. Phasellus eu tempus enim. Etiam viverra a ipsum non
            feugiat. Sed lobortis eget est vitae porttitor. Nullam magna lacus, bibendum a tristique sit amet, luctus
            vitae lorem.
          </Accordion>
          <Accordion title="Q2 What technologies do your developers specialize in?">
            <h3>Our developers specialize in a wide range of technologies including but not limited to:</h3>
            <ul className="ml-4 list-disc marker:text-[#9747FF]">
              ...
              <li>AI: Machine Learning, Natural Language Processing, Data Analysis</li>
            </ul>
          </Accordion>
        ...
        <div className="flex gap-4 self-end">
          ...
          <button onClick={onClose} className="text-semibold rounded-[100px] bg-[#9747FF] px-14 py-5">
            Ask Question
          </button>
        </div>
      </DialogContent>
...
const Accordion: React.FC<AccordionProps> = ({ title, children }) => {
  ...
  return (
    <div className={`rounded-xl px-12 py-7 ${isOpen ? "border border-zinc-400 bg-inherit" : "bg-black-500"}`}>
