        ...
        <div className="flex w-full  items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <Sheet open={openSheet} onOpenChange={setOpenSheet}>
              ...
              <SheetContent
                side="top"
                className="flex h-96 w-full flex-col items-center justify-center border-none bg-light-900 text-stone-900 dark:bg-stone-900 dark:text-white"
              >
                {navItems.map((item, index) => (
                  <Link
                    ...
                    href={item.path}
                    key={item.id}
                    className={`w-full ${index === 3 ? "border-none" : "border-black-100 border-b dark:border-b dark:border-light-900"}`}
                  >
