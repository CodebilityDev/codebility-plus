                                ...
                                >
                                    ...
                                    {isLoggedIn ? (
                                        <DropdownMenuItem className="focus:bg-[#9747FF] rounded-md"  >
                                            <Link href="#" onClick={handleLogout} className="w-full text-white text-base">
                                                Logout
                                            </Link>
                                        </DropdownMenuItem>
                                    ) : (
                            ...
                            >
                                ...
                                {isLoggedIn &&
                                    <button
                                        ...
                                        className={`w-full border-none  border-black-100 dark:border-light-900 cursor-pointer px-2 py-3 text-center text-base`}
                                    >
                                        Logout
                                    </button>
                                }
