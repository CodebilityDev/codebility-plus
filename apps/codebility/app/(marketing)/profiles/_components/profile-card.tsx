...
const ProfileCard = ({ codev, color }: Props) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-black-500 flex h-full w-full flex-col items-center justify-between gap-4 rounded-lg p-4 shadow-2xl lg:py-6`}
      >
        ...
        <div className="flex flex-col gap-1 text-center">
          ...
          {codev.main_position ? (
            <p className="text-gray text-sm">{codev.main_position}</p>
          ) : (
