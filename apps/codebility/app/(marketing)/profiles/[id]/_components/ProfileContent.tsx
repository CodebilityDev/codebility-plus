      ...
      >
          ...
          {linkedin && (
            ...
            >
              <Link
                ...
                target="_blank"
                className="bg-darkgray hover:bg-black-100 block rounded-lg p-2 transition duration-300"
              >
        ...
        {availableSchedule && (
          <motion.div className="mt-6 w-full" variants={fadeInUp}>
            ...
            <motion.div
              className="bg-black-100 flex flex-col gap-4 rounded-lg p-4"
                ...
                {allDays.map((day, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(
                        "flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-xs font-medium transition-all",
                        isAvailable
          ...
          <motion.div variants={fadeInUp}>
            ...
            >
              {education.map((edu) => (
                <motion.div
                  key={edu.id}
                  className="bg-black-100 mb-4 rounded-lg p-6"
                  variants={fadeInUp}
                  whileHover={{
                    x: 10,
