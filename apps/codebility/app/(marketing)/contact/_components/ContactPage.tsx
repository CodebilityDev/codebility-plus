        ...
        <div className="min-h-screen w-full bg-[#030303] text-white">
            ...
            >
                ...
                <div data-progressive-child className="relative w-full">
                    ...
                    <div
                        className={`absolute top-5 h-[2px] transition-all duration-500 ${currentStep > 1 ? "bg-violet-600" : "bg-white/5"
                            }`}
                    ...
                    <div className="relative flex items-start">
                        {steps.map((step, i) => {
                            ...
                            return (
                                <div key={i} className="relative z-10 flex flex-1 flex-col items-center gap-2">
                                    <div
                                        className={`flex h-10 w-10 items-center justify-center rounded-full border text-sm font-medium transition-all duration-300 ${isDone
                                    ...
                                    <p
                                        className={`text-center text-xs transition-colors duration-300 ${isDone
