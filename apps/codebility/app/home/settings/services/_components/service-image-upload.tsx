...
const ServiceImageUpload: React.FC<ServiceImageComponentProps> = ({
  selectedFile,
  imageType,
}) => {
  ...
  return (
    <>
      <div className="flex w-24 items-center justify-center border border-[#3F3F46]">
        <Image
          width={60}
          height={60}
      ...
      <div className="flex flex-1 flex-col items-start justify-center gap-1 border border-[#3F3F46] p-4 text-sm">
