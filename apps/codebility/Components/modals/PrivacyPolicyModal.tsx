    ...
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      <DialogContent className="h-4/5 w-full overflow-scroll">
        <div className="flex flex-col gap-8 py-10">
          ...
          <p>
            Thank you for choosing to be part of our community at Codebility ({"Company"}, {"we"}, {"us"}, or {"our"}).
            We are committed to protecting your personal information and your right to privacy. If you have any
            questions or concerns about our policy or our practices with regard to your personal information, please
            contact us at <a href="mailto:codebility.dev@gmail.com">codebility.dev@gmail.com</a>. When you visit our
            website and use our services, you trust us with your personal information.
          </p>
          <p>
            ...
            have in relation to it. We hope you take some time to read through it carefully, as it is important. If
            there are any terms in this privacy policy that you do not agree with, please discontinue the use of our
            Sites and our services.
          </p>
          <p>
            This privacy policy applies to all information collected through our website (
            <Link href="https://www.codebility.tech">https://www.codebility.tech/</Link>), and/or any related services,
          ...
          <ol className="flex list-decimal flex-col gap-5">
            <li>
              ...
              <p>
                ...
                personal information we collect may include the following:- Personal Information Provided by You. We
                collect names; phone numbers; email addresses; usernames; passwords; contact preferences; contact or
            ...
            <li>
              ...
              <p>
                ...
                fulfillment of our contract with you, compliance with our legal obligations, and/or your consent. We use
                personal information collected via our Services for a variety of business purposes described below. We
                ...
                If you choose to link your account with us to a third-party account (such as your Google or Facebook
            ...
            <li>
              ...
              <p>
                ...
                services, to protect your rights, or to fulfill business obligations. We may process or share your data
                that we hold based on the following legal basis: - Consent: We may process your data if you have given
            ...
            <li>
              ...
              <p>
                ...
                privacy policy unless otherwise required by law. We will only keep your personal information for as long
                ...
                policy will require us keeping your personal information for longer than the period of time in which
            ...
            <li>
              ...
              <p>
                ...
                such minor dependent{`'`}s use of the Services. If we learn that personal information from users less
            ...
            <li>
              ...
              <p>
                ...
                request access and obtain a copy of your personal information, (ii) to request rectification or erasure;
