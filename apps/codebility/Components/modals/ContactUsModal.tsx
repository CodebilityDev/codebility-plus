      ...
      >
        <div className="w-full flex-1 flex-col gap-4">
          ...
          <div className="text-center">
            ...
            <p className="md:text-md text-sm text-gray lg:text-lg">Explore how Codebility can empower you.</p>
          </div>
        </div>

        <div className="flex w-full flex-1 flex-col gap-3 rounded-lg bg-black-500 p-6 lg:gap-6">
          <p className="mb-2 text-center text-lg text-lightgray">Contact Information</p>
          ...
          <div>
            <Input
              ...
              onChange={(e) => {
                ...
                setValidationErrors((prevErrors) => ({ ...prevErrors, telephone: "" }))
              }}
            />
