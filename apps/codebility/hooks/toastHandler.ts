...
export const showSuccessToast = (message: string, id?: string) => showToast("success", message, id)
  ...
  if (statusCode) {
    switch (statusCode) {
      ...
      case 401:
        ...
        break
      case 403:
        toastMessage = "Forbidden. You do not have permission to perform this action."
        break
      case 404:
